            ...
            <div class="panel-body" style="padding: 20px;">
                ...
                >
                    ...
                    <div class="form-group">
                        <label for="inorout" class="col-sm-2 control-label">选择好友:</label>
                        <div class="col-sm-4">
                            <select name="friendid" id="inorout" class="form-control">
                                <%
                                    UserDao friends = new UserDaoImpl();

                                    User auth = (User) request.getSession().getAttribute("user");
                                    List<User> friendsList= new ArrayList<>();
                                    if (auth != null) {
                                        request.setAttribute("user", auth);
                                         friendsList = friends.getFriendsById(auth.getId());
                                    } else {
